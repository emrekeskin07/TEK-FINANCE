...
export default function AssetList() {
  ...
  return (
    <motion.section
      ...
      className="col-span-12 md:col-span-9 md:order-4 rounded-2xl border border-white/5 bg-slate-900/40 p-8 shadow-[0_24px_72px_rgba(2,6,23,0.62)] backdrop-blur-xl transition-all duration-300 hover:scale-[1.01] hover:border-fuchsia-400/35"
    >
      <PortfolioTable
        portfolio={portfolio}
